...
#trying an ordinal frequentist model who knows at this point 

df_diff$Q1_factor <- factor(df_diff$Q1, levels = c("1", "2", "3", "4", "5", "6", "7"))

clmm_Q1 <- clmm(Q1_factor ~ condition * type + 
                  (1|ResponseId) + 
                  (1|item), 
                  data = df_diff)
...
df_diff$Q2_factor <- factor(df_diff$Q2, levels = c("1", "2", "3", "4", "5", "6", "7"))

clmm_Q2 <- clmm(Q2_factor ~ condition * type + 
                  (1|ResponseId) + 
                  (1|item), 
                  data = df_diff)
```
